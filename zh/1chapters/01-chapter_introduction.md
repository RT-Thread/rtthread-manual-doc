...
* 一种是正式版本（或者说稳定版本，维护版本），例如当前的2.0.x正式版本，它是2.0.0正式版本的bug fix版本。在功能上并不添加新的功能，而着重于对已有bug的修正；
* 一种是测试版本（或者说开发版本），例如当前的2.1.0 beta版本。它是以一年期设定目标而演进，完善的版本，相对来说不那么稳定，但具备新的功能，对新的路线的探索；
